...
{
    [CreateAssetMenu(fileName = "New AudioTable", menuName = "GS/Resource/AudioTable")]
    public class AudioTable : GS.Resource.ResourceTable
    {
        ...
        [System.Serializable]
        public struct TaggedObject { public string tag;  public AudioClip data; }
        ...
        private AudioClip serializedData;
        // */
