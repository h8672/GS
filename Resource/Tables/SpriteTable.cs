...
namespace GS.Resource.Table
{
    ...
    /// String table.
    /// </summary>
    [CreateAssetMenu(fileName = "New SpriteTable", menuName = "GS/Resource/SpriteTable")]
    public class SpriteTable : GS.Resource.ResourceTable
    {
        ...
        [System.Serializable]
        public struct TaggedObject { public string tag;  public Sprite data; }
